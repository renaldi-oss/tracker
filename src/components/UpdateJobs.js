...
const UpdateJobs = ({ job, setJobsList }) => {
    ...
    if (name === "company_name") {
            if (!validator.isLength(value, { min: 0, max: 50 })) {
              setErrorMessages({
                ...errorMessages,
                company_name: "Karakter maksimal tercapai",
              });
            } else {
              setErrorMessages({
                ...errorMessages,
            ...
            if (!validator.isLength(value, { min: 0, max: 50 })) {
                setErrorMessages({
                ...errorMessages,
                job_role: "Karakter maksimal tercapai",
              });
            } else {
                setErrorMessages({
                ...errorMessages,
    ...
    if (name === "app_status" && value !== "Applied") {
        ...
        // ... digunakan untuk meng-copy semua properti dari objek yang sudah ada
...
useEffect(() => {
    ...
    return (
        <div>
            {/* 
                `id${job.id}` di bawah ini adalah id dari modal yang akan di update
            */}
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="dropdown">
                                ...
                                // render date input jika status bukan applied
                                <div>
